            ...
            <div class="sidebar">
                ...
                <ul>
                    <i class="fas fa-plane-departure"
                       style={{textDecoration: "none", color: "rgba(116, 116, 116, 0)", fontSize: "105px"}}> </i>
                    ...
                    <li>
                        <a href="/travelpackages" style={{textDecoration: "none", color: "white"}}>
                    ...
                    <div class="header">
                        ...
                        <div>
                            <div id="logott">
                                ...
                                {/*{<img src={img1} style={{width: "200px", height: "115px"}}/>}*/}

                            </div>
                            <div id="hname">
                                <h1><b> Discover Travelers</b></h1>
                            </div>
                        ...
                        <div className="menupp" style={{width: "100%"}}>
                            ...
                            <li class="menupp">
                                <a class="actively" style={{textDecoration: "none", color: "white"}}
                                   // href="/aboutus"
                                    >
                                    About Us
                                </a>
