...
import imag1 from "../../Images/sl.jpg";
import imag2 from "../../Images/hotel.jpg";
import imag3 from "../../Images/resorts.webp";
import imag4 from "../../Images/villas.jpg";
import imag5 from "../../Images/apartments.jpg";
import imag6 from "../../Images/cottages.jpg";
import imag7 from "../../Images/hh.jpg";
        ...
        <div class="info">
          <div className="container-fluid " id="bodyhome">
            ...
            <p className="parga">
              ...
              Sri Lanka tourism is characterized by its colonial architecture, and Buddhist temples, stunning beaches, and destinations like Colombo, Galle, Kandy, Yala National Park. Wildlife Sanctuaries with leopard and elephant populations are also some of the most popular places to visit in Sri Lanka.
              <br />
              <br />
