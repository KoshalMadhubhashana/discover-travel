  ...
  return (
    <div>
      ...
      <div className="container mx-auto">
        <div className="flex justify-center gap-28 mb-10 w-full">
          <div className="mybg text-center border-gray-900 px-56 mt-10 mb-10">
            <div className="mb-10">
              <div className="mt-20 flex">
                <div className=" -translate-x-6">
                  ...
                  >
                    <div>
                      <div className=" font-semibold text-xl -translate-x-16 mt-8 absolute">
                        Traveller Name
                      </div>
                      <Form.Item
                        name="first name"
