...
exports.register = async (req, res) => {
  ...
  try {
    const guid = await GuideModel.create({
      fullName,
      address,
      age,
      contactNo,
...
exports.login = async (req, res) => {
  ...
  try {
    const guid = await GuideModel.findOne({ username }).select("+password"); //match two passwords
...
exports.forgotPassword = async (req, res) => {
  ...
  try {
    const guid = await GuideModel.findOne({ email }); //check for email availability for sending emails
...
exports.resetPassword = async (req, res) => {
  ...
  try {
    const guid = await GuideModel.findOne({
      resetPasswordToken,
